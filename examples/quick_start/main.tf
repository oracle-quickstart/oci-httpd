...
module "bastion" {
  ...
  availability_domain   = "${module.network.ad3}"
  compartment_ocid      = "${var.compartment_ocid}"
...
module "apache_http_server1" {
  ...
  availability_domain   = "${module.network.ad1}"
  compartment_ocid      = "${var.compartment_ocid}"
  display_name          = "${var.instance_name}"
  image_id              = "${var.instance_image_id}"
  shape                 = "${var.instance_shape}"
  label_prefix          = "_1"
  subnet_id             = "${module.network.server1_subnet}"
...
module "apache_http_server2" {
  source                = "./modules/apache_http"
  availability_domain   = "${module.network.ad2}"
  compartment_ocid      = "${var.compartment_ocid}"
  display_name          = "${var.instance_name}"
  image_id              = "${var.instance_image_id}"
  shape                 = "${var.instance_shape}"
  label_prefix          = "_2"
  subnet_id             = "${module.network.server2_subnet}"
  http_port             = "${var.http_port}"
  https_port            = "${var.https_port}"
  enable_https          = "${var.enable_https}"
  create_selfsigned_cert= "${var.create_selfsigned_cert}"
...
module "apache_http_server3" {
  ...
  shape                 = "${var.instance_shape}"
  label_prefix          = "_3"
  subnet_id             = "${module.network.server3_subnet}"
  http_port             = "${var.http_port}"
  https_port            = "${var.https_port}"
  enable_https          = "${var.enable_https}"
  create_selfsigned_cert= "${var.create_selfsigned_cert}"
...
module "apache_load_balancer" {
  ...
  compartment_ocid      = "${var.compartment_ocid}"
  subnet_id1            = "${module.network.pri_lb_subnet}"
  subnet_id2            = "${module.network.sby_lb_subnet}"
