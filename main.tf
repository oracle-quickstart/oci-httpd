...
module "apache_http_server1" {
  ...
  address               = "${module.apache_load_balancer.loadbalancer_ip[0]}"
  //ca_cert             = "${module.apache_load_balancer.ca_certificate}"
  //priv_key            = "${module.apache_load_balancer.private_key}"
